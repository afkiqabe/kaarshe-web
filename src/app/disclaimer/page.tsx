...
export default async function DisclaimerPage() {
  const slug = process.env.WORDPRESS_DISCLAIMER_PAGE_SLUG ?? "disclaimer";
          ...
          <div className="mt-10 space-y-8 text-primary/70 leading-relaxed">
            <section className="space-y-2">
              ...
              <p>
                ...
                represent any government entity, political party, organization,
                or employer unless explicitly stated.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                external websites linked from Kaarshe.com.
              </p>
            </section>
