...
export default async function PrivacyPolicyPage() {
  const slug =
    process.env.WORDPRESS_PRIVACY_POLICY_PAGE_SLUG ?? "privacy-policy";
          ...
          <div className="mt-10 space-y-8 text-primary/70 leading-relaxed">
            <section className="space-y-2">
              ...
              <p>
                ...
                disclose information when you visit our website.
              </p>
              <p>
            ...
            <section className="space-y-2">
              ...
              <p>
                Kaarshe.com does not knowingly collect personal data from
