    ...
    <div className={cn(
      ...
      <div className="flex-1 pr-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-xs text-neutral-400 font-medium">Published {date}</span>
        </div>
      ...
      <div className="mt-6 md:mt-0 flex items-center gap-3 shrink-0">
        ...
        <button className="p-2.5 text-neutral-400 hover:text-primary border border-transparent hover:border-neutral-200 rounded-lg transition-all">
